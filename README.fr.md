...
## Pourquoi PicoNode.Actor

| Préoccupation | Options existantes | PicoNode.Actor |
|---------|:----------------:|:--------------:|
...
### PicoNode.Actor.Abs — Abstractions Fondamentales
...
| `IActorSystem` | Contrat d'exécution — Register, CreateAsync, GetAsync, Send, AskAsync, StopAsync |
...
| `ActorSystemOptions` | Options avec IEventStore et ILogger optionnels |
...
|---------|--------|-------------|
| [PicoNode.Actor.Abs](https://www.nuget.org/packages/PicoNode.Actor.Abs) | `netstandard2.0` | Abstractions fondamentales : `IActor`, `IActorSystem`, `ICommand`, `IDomainEvent`, `IEventStore`, `Actor`, `EventSourcedActor` |
| [PicoNode.Actor](https://www.nuget.org/packages/PicoNode.Actor) | `net10.0` | Exécution : `ActorSystem`, `InMemoryEventStore`, intégration PicoDI |

---

## Comparaison

| Fonctionnalité | PicoNode.Actor | Akka.NET | Proto.Actor | Orleans |
|---------|:---:|:--:|:--:|:--:|
| Mémoire uniquement | ✅ | ✅ | ✅ | ❌ |
| AOT / Trimming | ✅ | ❌ | ❌ | ❌ |
| Event Sourcing | ✅ | ✅ | ❌ | ❌ |
